function Invoke-SyncProperties($File) {
	...
	LogToFile -Text "Starting SyncProperties for $($File._Name)"
	$propertySync.SyncProperties($vault, $vaultFile, "Property Sync", $true, [ref]$writeResults, [ref]$cloakedEntityClasses, $true)
}
