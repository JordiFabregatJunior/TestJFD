...
class LoggingSettings {
    ...
    LoggingSettings() {
        ...
        $this.LogFile = "c:\Temp\_0_cOLog.txt"
...
function Log {
    ...
    End {
        try {
            ...
            if($global:loggingSettings.WriteHost) {
            ...
            if($MessageBox) { $null = New-MessageBox -Text $Message -Caption 'Message' -Button Ok -Icon Information }
